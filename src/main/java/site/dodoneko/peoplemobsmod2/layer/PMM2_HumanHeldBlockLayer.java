...
@OnlyIn(Dist.CLIENT)
public class PMM2_HumanHeldBlockLayer<E extends Mob, M extends PMM2_HumanoidModel<E> & ArmedModel>
        extends RenderLayer<E, M> {
    private final BlockRenderDispatcher blockRenderer;

    public PMM2_HumanHeldBlockLayer(RenderLayerParent<E, M> renderParent, BlockRenderDispatcher blockRenderer) {
        super(renderParent);
